    ...
    switch (faculty) {
        case 'CSC':
            victutors.list.CSClist = [
                ...
                victutors.list.CreateNewTutorEntry('CSC 110/115', '孙一鸣', '778 676 0201', 'sym199512@gmail.com', 'sym467165721', './Images/img_avatar1.png', './Images/NoQRCode.png', 'UVic computer science大三学生，java基础扎实，善于讲解算法，配合图像表现数据结构。辅导课程为CSC 110/115 （均以95分以上结课），包括作业答疑及考前复习等，有信心助您拿到理想的成绩。上课地点ECS，时间灵活，价格20CAD/小时。')
            ];
            break;
        case 'MATH':
            victutors.list.MATHlist = [
                ...
                victutors.list.CreateNewTutorEntry('大学数学,高中数学,大学物理,物理', '钟沐阳', '778 922 2992', 'zmybeihang@gmail.com', '358538990', './Images/img_avatar1.png', './Images/Math/muyanzhong.jpg', '北京航空航天大学物理学士，维多利亚大学物理硕士毕业，有四年的私教经验，擅长讲授大学一二年级数学和物理课程，也有大学工程课和高中数学物理的讲授经验。近年来家教学生超过70人。价格根据年纪和难度定，一般是从25CAD到35CAD/h')
            ];
            break;
        case 'ENGL':
            victutors.list.ENGLlist = [
