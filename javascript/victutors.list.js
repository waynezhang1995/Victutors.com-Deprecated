...
victutors.list.SetUplist = function(faculty) {
    switch (faculty) {
        case 'CSC':
            victutors.list.CSClist = [
                victutors.list.CreateNewTutorEntry('Comp 132/139,CSC 110/115,CSC 105', 'Wayne Zhang', '778 922 5080', 'waynez@uvic.ca', 'wayne-zhangyuwei', './Images/img_avatar1.png', './Images/CSC/waynezhang.png', 'UVIC的CSC大四学生. 拥有2年的Tutor经验,辅导过超过10个来自不同专业的学生. Tutor会为你讲解知识概念，辅导你解决习题、考试、编程作业等问题，并免费提供往届的练习题和模拟exam. 价格常年保障 $20/小时. 授课时间请微信联系'),
                ...
                victutors.list.CreateNewTutorEntry('CSC 110/115,CSC225', 'Grace Li', '778 922 4781', '请通过其他方式联系', 'gracelizr', './Images/img_avatar1.png', './Images/CSC/graceli.jpg', 'UVic SENG大三学生。可以辅导CSC110 115 225, 曾辅导过5个学生。请提前三天预约，价格20加元每小时。'),
                ...
                victutors.list.CreateNewTutorEntry('CSC110', 'Dover', '778 922 3861', 'marineincanada@gmail.com', 'CRRCCRRC', './Images/img_avatar1.png', './Images/CSC/Dover.JPG', 'Uvic CS 专业大四学生, 已累计近16 个月 Co-op work. 只专注 CSC110 辅导, 帮助理解概念, 作业解析及考前串讲, review. 擅长用简单例子解释复杂问题. 并可提前帮助理解 data structure, 为CSC115做铺垫. 每天7pm后或周末有空. $20/小时. 若要其他时间辅导可提前预约.')
            ];
            break;
        case 'MATH':
            victutors.list.MATHlist = [
