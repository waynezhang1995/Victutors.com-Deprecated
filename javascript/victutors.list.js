    ...
    switch (faculty) {
        case 'CSC':
            victutors.list.CSClist = [
                ...
                victutors.list.CreateNewTutorEntry("CSC110", "Dover", "778 922 3861", "marineincanada@gmail.com", "CRRCCRRC", "./Images/img_avatar1.png", "./Images/NoQRCode.png", "Uvic 大四学生, CSC专业, 目前Co-op中, 已累计 16 个月Co-op work term. 时间原因, 只专注 CSC110 辅导. 打好基础是王道~ 每天8pm后, 或周末有空. 提前预约~$20 / 小时~或孩儿们若有经济问题, 价钱可商量~毕竟挣钱不是目的~目的是带你飞~")
            ];
        case 'MATH':
            victutors.list.MATHlist = [
