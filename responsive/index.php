...
<head>
    ...
    <link rel="stylesheet" href="./responsive/lib/w3.css">
    <link rel="stylesheet" href="./responsive/css/custom.css">
    <link rel="stylesheet" href="http://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.3/css/font-awesome.min.css">
    <link href="./responsive/image/favicon.ico" rel="icon" type="image/x-icon" />
    <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css">
    <script src="./responsive/lib/jquery.js"></script>
    <script type="text/javascript" src="./responsive/lib/bootstrap.min.js"></script>
    <script type="text/javascript" src="./responsive/lib/bootstrap-select.js"></script>
    <script type="text/javascript" src="./responsive/js/victutors.js"></script>
    <script type="text/javascript" src="./responsive/js/victutors.list.js"></script>
    <script type="text/javascript" src="./responsive/js/victutors.functions.js"></script>
...
<body>
    <div id="Navbar">
        <ul id="navbarlogo">
            <li><a href="#home" class="w3-left"><img src="./responsive/image/icon_white.png">victutors.com</a></li>
        </ul>
        <ul id="navbarlist" class="topnav">
            <li id="home_link"><a href="#home">Victutor</a></li>
            <li><a href="#database" onclick="document.getElementById('databaseModal').style.display = 'block'">题库分享</a></li>
            <li><a href="#joinus" onclick="document.getElementById('joinUsModal').style.display = 'block'">成为家教</a></li>
            <li><a href="#about" onclick="document.getElementById('ContactUsModal').style.display = 'block'">联系我们</a></li>
            <li><a href="#feedback" onclick="document.getElementById('FeedbackModal').style.display = 'block'">问题反馈</a></li>
            <li><a href="#q&a" onclick="document.getElementById('FAQModal').style.display = 'block'">疑难解答</a></li>
        ...
        <div class="modal-content w3-animate-top w3-card-8">
            ...
            <div class="w3-container">
                    <div class="w3-row-padding" >
                        ...
                        <div class="w3-half">
                            <div class="group">
                                <div class="w3-center"><img id="ImgUpLoad" src="./responsive/image/Imgupload.png" style="width:50%" alt="WeChat"></div>
                                <div class="w3-center">
                                    <label>
        ...
        <div class="modal-content w3-animate-top w3-card-1">
            ...
            <div id="contact" class="w3-container">
                ...
                <div class="w3-half w3-center">
                    <img src="./responsive/image/WeChat.png" alt="WeChat">
                </div>
            </div>
            <footer class="w3-container">
                <p>www.victutors.com</p>
